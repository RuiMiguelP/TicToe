...
a persistence unit "second_projectPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "second_project\pom.xml":
...
artifact ("second_project.war") is already built. You can build
